...
//Write the annotation which adds both the @Controller
// and @ResponseBody annotations.
// You no longer need to add @ResponseBody annotation on all the request mapping methods
@RestController
...
public class SignupController {
    ...
    //This method is listening for a HTTP POST
    // request as indicated by method= RequestMethod.POST ,
    // maps to a URL request of type '/usersignup' and consumes and produces Json.
    @RequestMapping(method= RequestMethod.POST, path="/usersignup",
    ...
    public ResponseEntity<SignupUserResponse> userSignup(final SignupUserRequest signupUserRequest) {
        ...
        //After setting the attributes of userEntity,
        // pass it to signup() method, to add this object to a persistent context
