...
public class UserEntity implements Serializable {
    ...
    @Id
    //The @Column annotation helps to specify the properties of the column
    // to which this field or attribute will be matched.
    ...
    //Define a private attibute named "lastName" of type String,
    // explictly specify its column name as "LAST_NAME"
    // with notnull constraint and its maximum size should be 200
    ...
    //Define a private attibute named "salt" of type String,
    // explictly specify its column name as "SALT"
    // with notnull constraint and its maximum size should be 200
    @Column(name = "SALT")
    @NotNull
    @Size(max = 200)
    ...
    //After defining all the attributes with mentioned annotations
